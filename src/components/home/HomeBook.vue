<template>
  <div class="home-book">
        ...
        >
          ...
          >
            <ImageView
              :src="book.cover"
            />
            <div v-if="mode === HOME_BOOK_MODE.COL" class="book-title-wrapper book-title-column">
    ...
    <div v-if="showBtn" class="home-book-footer" @click="onMoreClick">
